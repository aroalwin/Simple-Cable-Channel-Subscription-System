                        ...
                        <form action="" method="POST">
                            <?php
                                ...
                                if (isset($_POST['registerbtn'])) {
                                    ...
                                    if (!empty($errors)) {
                                        ...
                                        $insert = mysqli_query($connection, "INSERT INTO users(name, email, phone,address, password) VALUES('$name', '$email', '$phone','$address', '$password')");
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <textarea type="text" name="address" value="<?php echo (isset($_POST['address']))? $_POST['address'] : ''; ?>" placeholder="Your Address" class="form-control form-control-lg"   required="">
                           </textarea>
						   </div>
